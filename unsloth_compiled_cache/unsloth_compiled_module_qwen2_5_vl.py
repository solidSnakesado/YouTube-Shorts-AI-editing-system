...
class Qwen2_5_VLMLP(nn.Module):
    ...
    def forward(self, hidden_state):
        return Qwen2_5_VLMLP_forward(self, hidden_state=hidden_state)
...
class Qwen2_5_VisionPatchEmbed(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        return Qwen2_5_VisionPatchEmbed_forward(self, hidden_states=hidden_states)


@torch.compile(fullgraph = True, dynamic = True, options = torch_compile_options)
def Qwen2_5_VisionRotaryEmbedding_forward(self, seqlen: int) -> torch.Tensor:
...
class Qwen2_5_VisionRotaryEmbedding(nn.Module):
    ...
    def forward(self, seqlen: int) -> torch.Tensor:
        return Qwen2_5_VisionRotaryEmbedding_forward(self, seqlen=seqlen)
...
class Qwen2_5_VLPatchMerger(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        return Qwen2_5_VLPatchMerger_forward(self, x=x)
...
Qwen2_5_VLForConditionalGeneration.__UNSLOTH_SUPPORTS_RETURN_HIDDEN_STATES__ = True
